...
clang++ -Wall -std=c++20 -stdlib=libc++ -I $PWD/third_party/spdlog/include/ -fmodules -fprebuilt-module-path=./modules_out -lpthread modules/error.cpp modules/coro.cpp modules/scheduler.cpp modules/awaitable.cpp main.cpp -o demo
...
# clang++ -Wall -std=c++20 -stdlib=libc++ -I $PWD/third_party/spdlog/include/ -fmodules -fprebuilt-module-path=./modules_out -lpthread modules/error.cpp modules/coro_noscheduler.cpp modules/awaitable_noscheduler.cpp main.cpp -o demo